...
std::shared_ptr<OperatorCostFunction> OperatorCostFunction::get_cost_function(OperatorCost cost_type) {
    OperatorCostFunction::default_cost_function = make_shared<OperatorCostConstant> (cost_type);	
    return OperatorCostFunction::default_cost_function;
}
