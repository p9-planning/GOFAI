...
CONFIGS = [("fasttext",["--translate-options", "--grounding-action-queue-ordering", "fasttext", 
                        "--relaxed-plan-file", "useful_facts",
                        "--trained-model-folder", CLASSIFIERS_FOLDER,
                        "--fasttext-model", EMBEDDING_FOLDER]),

           ("RR-ft",   ["--translate-options", "--grounding-action-queue-ordering", "roundrobinfasttext",
                        "--relaxed-plan-file", "useful_facts",
                        "--trained-model-folder", CLASSIFIERS_FOLDER,
                        "--fasttext-model", EMBEDDING_FOLDER]),

           ("ratio-ft",["--translate-options", "--grounding-action-queue-ordering", "ratiofasttext",
