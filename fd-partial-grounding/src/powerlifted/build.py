...
def get_build_dir(debug):
    if debug:
        return os.path.join(os.path.dirname(os.path.dirname(PROJECT_ROOT)), 'builds', 'powerlifted-debug', 'bin')
    else:
        return os.path.join(os.path.dirname(os.path.dirname(PROJECT_ROOT)), 'builds', 'powerlifted-release', 'bin')
