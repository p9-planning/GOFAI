...
class Task:
    def __init__(self, domain_name, task_name, requirements,
        ...
        self.constants = constants  # these are a subset of objects, but are required separately for some priority queues
        ...
        # list of facts achieved along a relaxed plan (of type sub-schema(obj-1 ..obj-n))
        # used to guide partial grounding
        # TODO move this to another place
        self.split_relaxed_plan_facts = []
